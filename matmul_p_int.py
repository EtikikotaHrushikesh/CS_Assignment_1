...
n=int(input())
A = [[(r.randint(0,100)) for i in range (n)]for _ in range(n)]
 
# take a 3x4 matrix   
B = [[r.randint(0,100) for i in range (n)]for _ in range(n)]
result = [[r.randint(0,100) for i in range (n)]for _ in range(n)]
